...
void setup() {
  ...
  strs[0][0] = "Hey there!";
  strs[0][1] = "My name is Shashree Samuel";
  
  strs[1][0] = "I've been teaching myself how to code for 3 years!";
  strs[1][1] = "I am currently programming in Java, C++, Ruby, Python";
  
  strs[2][0] = "Feel free to reach out to say hi!";
  strs[2][1] = "discord: Shash#7399 | email: shashreesamuel12@gmail.com";
}
